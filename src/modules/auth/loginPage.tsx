...
import { useNavigate } from "react-router-dom"; // Removemos o 'Link' pois não há cadastro público
...
              <Button
                type="submit"
                className="w-full mt-4 bg-[#003b5c] hover:bg-[orange]" // Estilo do Botão
                disabled={isLoading}
              >
                {isLoading ? "Entrando..." : <>Entrar</>}
              </Button>

              {/* ⬅️ REMOVIDO: O Link de Cadastro Público */}
            </form>
          </CardContent>
        </Card>
      </div>
