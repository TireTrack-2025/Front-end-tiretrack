...
const Sidebar = ({ isOpen, toggle }: SidebarProps) => {
  ...
  return (
    <aside
      className={cn(
        "bg-[#0D202C] text-sidebar-foreground flex flex-col transition-all duration-300 ease-in-out",
        isOpen ? "w-64" : "w-20"
      )}
    >
...
const Header = () => {
  ...
  return (
    <header className="h-16 bg-gradient-to-r from-[#E85D31] to-[#F67F1D]  flex items-center justify-between px-6 shadow-sm">
